...
Please note: pull requests will only be approved for the 'collaborative' titled file. The others will stay static to match the logic used in my videos and on the website.
